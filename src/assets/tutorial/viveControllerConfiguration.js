...
var viveTriggerModelURL = "atp:/controller/vive_trigger.fbx"
    ...
    controllers: [
        {
            ...
            parts: {
                tips: {
                    ...
                    textureLayers: {
                        blank: {
                            defaultTextureURL: viveTipsModelURL + "/vive-tips.fbm/Blank.png",
                        },
                        trigger: {
                            defaultTextureURL: viveTipsModelURL + "/vive-tips.fbm/Trigger.png",
                        },
                        arrows: {
                            defaultTextureURL: viveTipsModelURL + "/vive-tips.fbm/Rotate.png",
                        },
                        grip: {
                            defaultTextureURL: viveTipsModelURL + "/vive-tips.fbm/Grip.png",
                        },
                        teleport: {
                            defaultTextureURL: viveTipsModelURL + "/vive-tips.fbm/Teleport.png",
                        },
                    }
                },
